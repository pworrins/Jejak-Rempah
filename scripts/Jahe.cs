...
public partial class Jahe : Area3D
{
	// Signal untuk ketika jahe dikumpulkan dengan nilai poin
	[Signal]
	...
	[Export]
	public int point_value = 2; // Total poin jika mengenai jahe = 2
	...
	public void Collected(Player body)
	{
		...
		EmitSignal("GingerCollected", point_value);
		
		// Debug print untuk memastikan signal dipanggil
		GD.Print($"Jahe collected! Points: {point_value}");
